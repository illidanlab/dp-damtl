...
public class ServerThread_Trace_oneTest implements Callable<AMTL_Matrix>{
...
Socket socket;
	...
	public ServerThread_Trace_oneTest(Socket clientSocket, int dim, AMTL_Matrix a, double StepSize, double Lambda) {
